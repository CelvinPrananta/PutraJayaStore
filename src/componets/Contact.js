              ...
              >
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6">
                  <div className="lg:mb-0 text-center mx-auto">
                    ...
                    <h6 className="font-medium">Surabaya</h6>
                  </div>
                  <div className="lg:mb-0 text-center mx-auto">
                    <a
                    ...
                    <h6 className="font-medium">Jl. Kedungdoro No.101-101 A, Surabaya 60261, Indonesia</h6>
                  </div>
                  <div className="mb-6 md:mb-0 text-center mx-auto">
                    <a href="tel: +62081255678912">
                      <svg
                        className="w-8 h-8 text-blue-500 mb-6 mx-auto cursor-pointer"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    ...
                    <h6 className="font-medium">+6281138867000</h6>
                  </div>
                </div>
